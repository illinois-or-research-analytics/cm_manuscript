...
0.0001 & 39069 & 91.81 &  11 & 177.00 & 176557 \\ 
   \hline
\end{tabular}
\caption{Clustering the Open Citations Network. The open citations network (Materials and Methods) consisting of 75,025,194 nodes and 1,363,605,603 edges was clustered using the Leiden algorithm with the Constant Potts Model (CPM ) as quality function using various resolution values (column 1). Column 2 shows the number of clusters of at least size 11. Node coverage is expressed as the the percent of nodes in these clusters relative to the total number of nodes in the network. Minimum, median, and max cluster sizes are shown in the last three columns.
 }
\end{table}
